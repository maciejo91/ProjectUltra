    ...
    contracts: [
      {
        ...
        contractNotes: 'Contratto finale firmato.',
        contractSigned: true,
    ...
    contracts: [
      {
        ...
        contractNotes: 'VIP contract signed.',
        contractSigned: true,
...
export const mockOpportunities = [
  ...
  // ========================================
  // COPERTURA COMPLETA - Tutte le combinazioni Stage/Data/Assegnazione
  // IDs 200-299 per copertura sistematica
  // ========================================
  
  // 200-209: Variazioni Stage Qualified
  {
    id: 200,
    customerId: 1,
    requestedCar: { 
    ...
    tags: [],
    value: 45000,
    expectedCloseDate: createDateString(-7), // Data passata
    assignee: 'Salsabeel Khaleel',
  ...
  },
  {
    ...
    tags: [],
    value: 42000,
    expectedCloseDate: createDateString(0), // Oggi
    assignee: null, // Non assegnato
  ...
  },
  {
    ...
    tags: [],
    value: 48000,
    expectedCloseDate: createDateString(14), // Data futura
    assignee: 'David Miller',
  ...
  },
  {
    ...
    tags: [],
    value: 32000,
    expectedCloseDate: createDateString(30), // Data futura
    assignee: 'Sarah Jenkins',
    createdAt: createDateOffset(-10), // 10 giorni fa - attiva OOFB (7-13 giorni)
  ...
  },
  {
    ...
    tags: [],
    value: 55000,
    expectedCloseDate: createDateString(45), // Data futura
    assignee: 'Michael Thomas',
    createdAt: createDateOffset(-20), // 20 giorni fa - attiva UFB (14+ giorni)
  ...
  },
  {
    ...
    tags: [],
    value: 60000,
    expectedCloseDate: createDateString(20), // Data futura
    assignee: 'Salsabeel Khaleel',
    createdAt: createDateOffset(-2),
    lastActivity: createDateOffset(-1),
    scheduledAppointment: {
      id: 205,
      title: 'Appuntamento prova',
      start: createDateOffset(3), // Appuntamento futuro
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 3)
        date.setHours(15, 0, 0, 0)
  ...
  },
  {
    ...
    tags: ['Premium'],
    value: 95000,
    expectedCloseDate: createDateString(25), // Data futura
    assignee: null, // Non assegnato
    ...
    scheduledAppointment: {
      id: 206,
      title: 'Consultazione',
      start: createDateOffset(0), // Appuntamento oggi
      end: (() => {
        const date = new Date()
        date.setHours(15, 0, 0, 0)
        return date.toISOString()
  ...
  },
  {
    ...
    tags: [],
    value: 65000,
    expectedCloseDate: createDateString(-5), // Data passata
    assignee: 'David Miller',
    createdAt: createDateOffset(-8),
    lastActivity: createDateOffset(-3),
    scheduledAppointment: {
      id: 207,
      title: 'Appuntamento passato',
      start: createDateOffset(-5), // Appuntamento passato
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() - 5)
        date.setHours(14, 0, 0, 0)
  ...
  // 210-219: Appointment Scheduled Variations
  {
    ...
    scheduledAppointment: {
      id: 210,
      title: 'Appuntamento futuro',
      start: createDateOffset(5), // Appuntamento futuro
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 5)
  ...
  },
  {
    ...
    tags: [],
    value: 58000,
    expectedCloseDate: createDateString(-10), // Data passata
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(-10),
    scheduledAppointment: {
      id: 211,
      title: 'Appuntamento passato - No-Show',
      start: createDateOffset(-3), // Appuntamento passato
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() - 3)
  ...
  },
  {
    ...
    tags: ['Premium'],
    value: 85000,
    expectedCloseDate: createDateString(15), // Data futura
    assignee: 'Salsabeel Khaleel',
    createdAt: createDateOffset(-12),
    lastActivity: createDateOffset(-5),
    scheduledAppointment: {
      id: 213,
      title: 'Appuntamento NS2',
      start: createDateOffset(-8), // Appuntamento passato
      end: (() => {
        const date = new Date()
  ...
  },
  {
    ...
    tags: ['Premium', 'Luxury'],
    value: 120000,
    expectedCloseDate: createDateString(10), // Data futura
    assignee: 'David Miller',
    createdAt: createDateOffset(-20),
    lastActivity: createDateOffset(-10),
    scheduledAppointment: {
      id: 214,
      title: 'Appuntamento NS3 - Dovrebbe chiudersi automaticamente',
      start: createDateOffset(-12), // Appuntamento passato
      end: (() => {
        const date = new Date()
  ...
  // 220-229: In Negotiation - Offer Sent Variations
  {
    ...
    offers: [
      {
        id: 'offer-220-1',
        createdAt: createDateOffset(-2), // < 3 giorni
        vehicleBrand: 'BMW',
        vehicleModel: 'i4',
        vehicleYear: 2024,
        price: 65000,
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-221-1',
        createdAt: createDateOffset(-1), // < 3 giorni
        vehicleBrand: 'Audi',
        vehicleModel: 'e-tron',
        vehicleYear: 2024,
        price: 75000,
  ...
  },
  {
    ...
    tags: ['Electric'],
    value: 45000,
    expectedCloseDate: createDateString(18), // Data futura
    assignee: 'Michael Thomas',
    createdAt: createDateOffset(-4),
    lastActivity: createDateOffset(-1),
    scheduledAppointment: {
      id: 223,
      title: 'Prova su strada',
      start: createDateOffset(2), // Appuntamento futuro
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 2)
        date.setHours(11, 0, 0, 0)
  ...
  // 230-239: In Negotiation - Offer Under Review Variations
  {
    ...
    offers: [
      {
        id: 'offer-230-1',
        createdAt: createDateOffset(-5), // 5 giorni - attiva OFB (5+ giorni)
        vehicleBrand: 'BMW',
        vehicleModel: 'X3',
        vehicleYear: 2024,
        price: 55000,
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-231-1',
        createdAt: createDateOffset(-4), // 4 giorni
        vehicleBrand: 'Audi',
        vehicleModel: 'Q7',
        vehicleYear: 2024,
        price: 85000,
    ...
    tags: ['Premium'],
    value: 85000,
    expectedCloseDate: createDateString(-8), // Data passata
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-15),
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-232-1',
        createdAt: createDateOffset(-6), // 6 giorni - attiva OFB
        vehicleBrand: 'Mercedes-Benz',
        vehicleModel: 'GLE',
        vehicleYear: 2024,
        price: 78000,
    ...
    scheduledAppointment: {
      id: 232,
      title: 'Appuntamento di follow-up',
      start: createDateOffset(7), // Appuntamento futuro
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 7)
        date.setHours(10, 0, 0, 0)
  ...
  },
  {
    ...
    tags: ['Premium', 'Performance'],
    value: 130000,
    expectedCloseDate: createDateString(-3), // Data passata
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-25),
    lastActivity: createDateOffset(-5),
    scheduledAppointment: null
  ...
  // 250-259: In Negotiation - Contract Pending Variations
  {
    ...
    selectedVehicle: null,
    stage: 'In Negotiation',
    negotiationSubstatus: 'Offer Sent', // Contract Pending determinato da contractDate
    offers: [
      {
        id: 'offer-250-1',
        createdAt: createDateOffset(-12),
    ...
    contracts: [
      {
        id: 'contract-250-1',
        contractDate: createDateOffset(-8), // 8 giorni fa - attiva CFB (7+ giorni)
        contractNotes: 'Contratto in attesa.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      }
    ...
    tags: ['Premium', 'Luxury'],
    value: 110000,
    expectedCloseDate: createDateString(5), // Data futura
    assignee: 'Salsabeel Khaleel',
    createdAt: createDateOffset(-20),
  ...
  },
  {
    ...
    contracts: [
      {
        id: 'contract-251-1',
        contractDate: createDateOffset(-1), // Contratto recente
        contractNotes: 'Contratto preparato.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      },
    ...
    tags: ['Premium', 'Luxury'],
    value: 120000,
    expectedCloseDate: createDateString(-2), // Data passata
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(-1),
  ...
  },
  {
    ...
    contracts: [
      {
        id: 'contract-252-1',
        contractDate: createDateOffset(0), // Oggi
        contractNotes: 'Contratto creato oggi.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      }
  ...
  // 260-269: Closed Won - None (no delivery tracking)
  {
    ...
    contracts: [
      {
        id: 'contract-260-1',
        contractDate: createDateOffset(-15),
        contractNotes: 'Contratto firmato.',
        contractSigned: true,
        esignatureCollectedDate: createDateOffset(-15),
        version: 1,
        status: 'signed'
    ...
    tags: ['Premium'],
    value: 95000,
    expectedCloseDate: createDateString(-15), // Data passata
    assignee: 'Sarah Jenkins',
  ...
  // 270-279: Closed Won - Awaiting Delivery Variations
  {
    ...
    lastActivity: createDateOffset(-5),
    contractDate: createDateOffset(-12),
    deliveryDate: createDateString(5), // Data di consegna futura
    scheduledAppointment: null
  },
  {
    id: 271,
    ...
    lastActivity: createDateOffset(-3),
    contractDate: createDateOffset(-15),
    deliveryDate: createDateString(3), // Data di consegna futura
    scheduledAppointment: null
  },
  ...
  // 280-289: Closed Won - Delivered Variations
  {
    ...
    value: 105000,
    expectedCloseDate: createDateString(-25), // Data passata
    assignee: 'Sarah Jenkins',
    createdAt: createDateOffset(-40),
    lastActivity: createDateOffset(-5), // 5 giorni dopo consegna - attiva DFB (3+ giorni)
    contractDate: createDateOffset(-25),
    deliveryDate: createDateString(-5), // Data di consegna passata
    scheduledAppointment: null
  },
  {
    id: 281,
    ...
    lastActivity: createDateOffset(-4), // 4 giorni dopo consegna - attiva DFB
    contractDate: createDateOffset(-22),
    deliveryDate: createDateString(-4), // Data di consegna passata
    scheduledAppointment: null
  },
  ...
  // 290: Closed Lost with offers + unsigned contract (customer chose competitor)
  {
    ...
    lastActivity: createDateOffset(-5),
    contractDate: null,
    closedReason: 'Il cliente ha scelto un concorrente',
  ...
  // 291: Closed Lost with offers (no longer interested after negotiation)
  {
    ...
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(0), // Chiuso oggi
    contractDate: null,
    closedReason: 'Non più interessato',
  ...
  // 292: Closed Lost, no offers (NS3 - third no-show before offers sent)
  {
    ...
    lastActivity: createDateOffset(-10),
    contractDate: null,
    closedReason: 'NS3 - Terzo No-Show',
    closedDate: createDateOffset(-10), // Data di chiusura passata
    scheduledAppointment: null
  },
  {
    id: 293,
    ...
    tags: [],
    value: 36000,
    expectedCloseDate: createDateString(-35), // Data passata
    assignee: 'David Miller',
    createdAt: createDateOffset(-50), // 50 giorni fa
    lastActivity: createDateOffset(-35), // 35 giorni inattivo - attiva Abandoned
    scheduledAppointment: null
  },
  {
    id: 294,
    ...
    tags: [],
    value: 40000,
    expectedCloseDate: createDateString(-40), // Data passata
    assignee: null, // Non assegnato
    createdAt: createDateOffset(-45), // 45 giorni fa
    lastActivity: createDateOffset(-32), // 32 giorni inattivo - attiva Abandoned
    scheduledAppointment: null
  },
