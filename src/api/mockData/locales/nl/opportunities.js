    ...
    contracts: [
      {
        ...
        contractNotes: 'Definitief contract ondertekend.',
        contractSigned: true,
    ...
    contracts: [
      {
        ...
        contractNotes: 'VIP contract ondertekend.',
        contractSigned: true,
...
export const mockOpportunities = [
  ...
  // ========================================
  // VOLLEDIGE DEKKING - Alle Stage/Datum/Toewijzing Combinaties
  // IDs 200-299 voor systematische dekking
  // ========================================
  
  // 200-209: Qualified Stage Variaties
  {
    id: 200,
    customerId: 1,
    requestedCar: { 
    ...
    tags: [],
    value: 45000,
    expectedCloseDate: createDateString(-7), // Verleden datum
    assignee: 'Salsabeel Khaleel',
  ...
  },
  {
    ...
    tags: [],
    value: 42000,
    expectedCloseDate: createDateString(0), // Vandaag
    assignee: null, // Niet toegewezen
  ...
  },
  {
    ...
    tags: [],
    value: 48000,
    expectedCloseDate: createDateString(14), // Toekomstige datum
    assignee: 'David Miller',
  ...
  },
  {
    ...
    tags: [],
    value: 32000,
    expectedCloseDate: createDateString(30), // Toekomstige datum
    assignee: 'Sarah Jenkins',
    createdAt: createDateOffset(-10), // 10 dagen geleden - triggert OOFB (7-13 dagen)
  ...
  },
  {
    ...
    tags: [],
    value: 55000,
    expectedCloseDate: createDateString(45), // Toekomstige datum
    assignee: 'Michael Thomas',
    createdAt: createDateOffset(-20), // 20 dagen geleden - triggert UFB (14+ dagen)
  ...
  },
  {
    ...
    tags: [],
    value: 60000,
    expectedCloseDate: createDateString(20), // Toekomstige datum
    assignee: 'Salsabeel Khaleel',
    ...
    scheduledAppointment: {
      ...
      start: createDateOffset(3), // Toekomstige afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 3)
        date.setHours(15, 0, 0, 0)
  ...
  },
  {
    ...
    tags: ['Premium'],
    value: 95000,
    expectedCloseDate: createDateString(25), // Toekomstige datum
    assignee: null, // Niet toegewezen
    ...
    scheduledAppointment: {
      id: 206,
      title: 'Consultatie',
      start: createDateOffset(0), // Afspraak vandaag
      end: (() => {
        const date = new Date()
        date.setHours(15, 0, 0, 0)
        return date.toISOString()
  ...
  },
  {
    ...
    tags: [],
    value: 65000,
    expectedCloseDate: createDateString(-5), // Verleden datum
    assignee: 'David Miller',
    ...
    scheduledAppointment: {
      ...
      start: createDateOffset(-5), // Verleden afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() - 5)
        date.setHours(14, 0, 0, 0)
  ...
  // 210-219: Appointment Scheduled Variaties
  {
    id: 210,
    customerId: 11,
    requestedCar: { 
    ...
    scheduledAppointment: {
      id: 210,
      title: 'Toekomstige afspraak',
      start: createDateOffset(5), // Toekomstige afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 5)
  ...
  },
  {
    ...
    tags: [],
    value: 58000,
    expectedCloseDate: createDateString(-10), // Verleden datum
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(-10),
    scheduledAppointment: {
      id: 211,
      title: 'Verleden No-Show afspraak',
      start: createDateOffset(-3), // Verleden afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() - 3)
  ...
  },
  {
    ...
    scheduledAppointment: {
      ...
      start: createDateOffset(0), // Vandaag
      end: (() => {
        const date = new Date()
        date.setHours(14, 0, 0, 0)
        return date.toISOString()
  ...
  },
  {
    ...
    tags: ['Premium'],
    value: 85000,
    expectedCloseDate: createDateString(15), // Toekomstige datum
    assignee: 'Salsabeel Khaleel',
    createdAt: createDateOffset(-12),
    ...
    scheduledAppointment: {
      id: 213,
      title: 'NS2 Afspraak',
      start: createDateOffset(-8), // Verleden afspraak
      end: (() => {
        const date = new Date()
  ...
  },
  {
    ...
    tags: ['Premium', 'Luxury'],
    value: 120000,
    expectedCloseDate: createDateString(10), // Toekomstige datum
    assignee: 'David Miller',
    createdAt: createDateOffset(-20),
    lastActivity: createDateOffset(-10),
    scheduledAppointment: {
      id: 214,
      title: 'NS3 Afspraak - Zou automatisch moeten sluiten',
      start: createDateOffset(-12), // Verleden afspraak
      end: (() => {
        const date = new Date()
  ...
  // 220-229: In Negotiation - Offer Sent Variaties
  {
    id: 220,
    customerId: 21,
    requestedCar: { 
    ...
    offers: [
      {
        id: 'offer-220-1',
        createdAt: createDateOffset(-2), // < 3 dagen
        vehicleBrand: 'BMW',
        vehicleModel: 'i4',
        vehicleYear: 2024,
        price: 65000,
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-221-1',
        createdAt: createDateOffset(-1), // < 3 dagen
        vehicleBrand: 'Audi',
        vehicleModel: 'e-tron',
        vehicleYear: 2024,
        price: 75000,
  ...
  },
  {
    ...
    tags: ['Electric'],
    value: 45000,
    expectedCloseDate: createDateString(18), // Toekomstige datum
    assignee: 'Michael Thomas',
    ...
    scheduledAppointment: {
      id: 223,
      title: 'Proefrit',
      start: createDateOffset(2), // Toekomstige afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 2)
        date.setHours(11, 0, 0, 0)
  ...
  // 230-239: In Negotiation - Offer Under Review Variaties
  {
    id: 230,
    customerId: 31,
    requestedCar: { 
    ...
    offers: [
      {
        id: 'offer-230-1',
        createdAt: createDateOffset(-5), // 5 dagen - triggert OFB (5+ dagen)
        vehicleBrand: 'BMW',
        vehicleModel: 'X3',
        vehicleYear: 2024,
        price: 55000,
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-231-1',
        createdAt: createDateOffset(-4), // 4 dagen
        vehicleBrand: 'Audi',
        vehicleModel: 'Q7',
        vehicleYear: 2024,
        price: 85000,
    ...
    tags: ['Premium'],
    value: 85000,
    expectedCloseDate: createDateString(-8), // Verleden datum
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-15),
  ...
  },
  {
    ...
    offers: [
      {
        id: 'offer-232-1',
        createdAt: createDateOffset(-6), // 6 dagen - triggert OFB
        vehicleBrand: 'Mercedes-Benz',
        vehicleModel: 'GLE',
        vehicleYear: 2024,
        price: 78000,
    ...
    scheduledAppointment: {
      ...
      start: createDateOffset(7), // Toekomstige afspraak
      end: (() => {
        const date = new Date()
        date.setDate(date.getDate() + 7)
        date.setHours(10, 0, 0, 0)
  ...
  // 240-249: In Negotiation - Offer Accepted Variaties
  {
    id: 240,
    customerId: 41,
    requestedCar: { 
  ...
  },
  {
    ...
    tags: ['Premium', 'Performance'],
    value: 130000,
    expectedCloseDate: createDateString(-3), // Verleden datum
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-25),
    lastActivity: createDateOffset(-5),
    scheduledAppointment: null
  ...
  // 250-259: In Negotiation - Contract Pending Variaties
  {
    id: 250,
    customerId: 6,
    requestedCar: { 
    ...
    selectedVehicle: null,
    stage: 'In Negotiation',
    negotiationSubstatus: 'Offer Sent', // Contract Pending bepaald door contractDate
    offers: [
      {
        id: 'offer-250-1',
        createdAt: createDateOffset(-12),
    ...
    contracts: [
      {
        id: 'contract-250-1',
        contractDate: createDateOffset(-8), // 8 dagen geleden - triggert CFB (7+ dagen)
        contractNotes: 'Contract in afwachting.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      }
    ...
    tags: ['Premium', 'Luxury'],
    value: 110000,
    expectedCloseDate: createDateString(5), // Toekomstige datum
    assignee: 'Salsabeel Khaleel',
    createdAt: createDateOffset(-20),
  ...
  },
  {
    ...
    contracts: [
      {
        ...
        contractNotes: 'Contract voorbereid.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      },
    ...
    tags: ['Premium', 'Luxury'],
    value: 120000,
    expectedCloseDate: createDateString(-2), // Verleden datum
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(-1),
  ...
  },
  {
    ...
    contracts: [
      {
        id: 'contract-252-1',
        contractDate: createDateOffset(0), // Vandaag
        contractNotes: 'Contract vandaag aangemaakt.',
        contractSigned: false,
        version: 1,
        status: 'pending'
      }
  ...
  // 260-269: Closed Won - None (no delivery tracking)
  {
    ...
    contracts: [
      {
        id: 'contract-260-1',
        contractDate: createDateOffset(-15),
        contractNotes: 'Contract ondertekend.',
        contractSigned: true,
        esignatureCollectedDate: createDateOffset(-15),
        version: 1,
        status: 'signed'
    ...
    tags: ['Premium'],
    value: 95000,
    expectedCloseDate: createDateString(-15), // Verleden datum
    assignee: 'Sarah Jenkins',
    createdAt: createDateOffset(-30),
  ...
  // 270-279: Closed Won - Awaiting Delivery Variaties
  {
    id: 270,
    customerId: 26,
    requestedCar: { 
    ...
    lastActivity: createDateOffset(-5),
    contractDate: createDateOffset(-12),
    deliveryDate: createDateString(5), // Toekomstige leveringsdatum
    scheduledAppointment: null
  },
  {
    id: 271,
    ...
    lastActivity: createDateOffset(-3),
    contractDate: createDateOffset(-15),
    deliveryDate: createDateString(3), // Toekomstige leveringsdatum
    scheduledAppointment: null
  },
  
  // 280-289: Closed Won - Delivered Variaties
  {
    id: 280,
    customerId: 36,
    requestedCar: { 
    ...
    value: 105000,
    expectedCloseDate: createDateString(-25), // Verleden datum
    assignee: 'Sarah Jenkins',
    createdAt: createDateOffset(-40),
    lastActivity: createDateOffset(-5), // 5 dagen na levering - triggert DFB (3+ dagen)
    contractDate: createDateOffset(-25),
    deliveryDate: createDateString(-5), // Verleden leveringsdatum
    scheduledAppointment: null
  },
  {
    id: 281,
    ...
    lastActivity: createDateOffset(-4), // 4 dagen na levering - triggert DFB
    contractDate: createDateOffset(-22),
    deliveryDate: createDateString(-4), // Verleden leveringsdatum
    scheduledAppointment: null
  },
  
  // 290-299: Closed Lost and Abandoned Variaties
  // 290: Closed Lost with offers + unsigned contract (customer chose competitor)
  {
    ...
    lastActivity: createDateOffset(-5),
    contractDate: null,
    closedReason: 'Klant koos voor concurrent',
    closedDate: createDateOffset(-5), // Verleden sluitingsdatum
    scheduledAppointment: null
  },
  // 291: Closed Lost with offers (no longer interested after negotiation)
  {
    ...
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-15),
    lastActivity: createDateOffset(0), // Vandaag gesloten
    contractDate: null,
    closedReason: 'Niet meer geïnteresseerd',
    closedDate: createDateOffset(0), // Vandaag
    scheduledAppointment: null
  },
  // 292: Closed Lost, no offers (NS3 - third no-show before offers sent)
  {
    ...
    lastActivity: createDateOffset(-10),
    contractDate: null,
    closedReason: 'NS3 - Derde No-Show',
    closedDate: createDateOffset(-10), // Verleden sluitingsdatum
    scheduledAppointment: null
  },
  {
    id: 293,
    ...
    tags: [],
    value: 36000,
    expectedCloseDate: createDateString(-35), // Verleden datum
    assignee: 'David Miller',
    createdAt: createDateOffset(-50), // 50 dagen geleden
    lastActivity: createDateOffset(-35), // 35 dagen inactief - triggert Abandoned
    scheduledAppointment: null
  },
  {
    id: 294,
    ...
    tags: [],
    value: 40000,
    expectedCloseDate: createDateString(-40), // Verleden datum
    assignee: null, // Niet toegewezen
    createdAt: createDateOffset(-45), // 45 dagen geleden
    lastActivity: createDateOffset(-32), // 32 dagen inactief - triggert Abandoned
    scheduledAppointment: null
  },
