export const mockUsers = [
  ...
  { id: 8, name: 'Sofia Romano', initials: 'SR', role: 'salesman', email: 'sofia.romano@example.com', team: 'Sales (New)', teamId: 14, dealership: 'Trento', fiscalEntityId: 'company-a' },
  { id: 9, name: 'Alessandro Conti', initials: 'AC', role: 'manager', email: 'alessandro.conti@example.com', team: 'General', teamId: 3, dealership: 'Milano', fiscalEntityId: 'company-a' },
  { id: 10, name: 'Francesca Moretti', initials: 'FM', role: 'salesman', email: 'francesca.moretti@example.com', team: 'Sales (Rent)', teamId: 6, dealership: 'Firenze', fiscalEntityId: 'company-a' },
  { id: 11, name: 'Andrea Colombo', initials: 'AC', role: 'operator', email: 'andrea.colombo@example.com', team: 'Call Center', teamId: 2, dealership: 'Milano', fiscalEntityId: 'company-a' },
  { id: 12, name: 'Elena Marchetti', initials: 'EM', role: 'salesman', email: 'elena.marchetti@example.com', team: 'Sales (Used)', teamId: 7, dealership: 'Firenze', fiscalEntityId: 'company-a' },
